...
### Architecture
*   **[Android Architecture](skills/architecture/android-architecture/SKILL.md)** - Expert guidance on **Clean Architecture**, **Modularization**, and **Dependency Injection** with **Hilt**.
*   **[ViewModel & State](skills/architecture/android-viewmodel/SKILL.md)** - Proper implementation using `StateFlow` and `SharedFlow`.
*   **[Data Layer & Offline-First](skills/architecture/android-data-layer/SKILL.md)** - **Repository Pattern** with **Room** and **Retrofit**.

### UI (Compose & Legacy)
*   **[Jetpack Compose UI](skills/ui/compose-ui/SKILL.md)** - Best practices for stateless, performant Composables.
*   **[Compose Navigation](skills/ui/compose-navigation/SKILL.md)** - Type-safe navigation, deep links, and nested graphs.
*   **[Coil for Jetpack Compose](skills/ui/coil-compose/SKILL.md)** - Expert guidance on image loading in Compose.
*   **[Accessibility](skills/ui/android-accessibility/SKILL.md)** - Auditing content descriptions, touch targets, and contrast.

### Migration
*   **[XML to Compose Migration](skills/migration/xml-to-compose-migration/SKILL.md)** - Converting XML layouts to idiomatic Jetpack Compose.
*   **[RxJava to Coroutines Migration](skills/migration/rxjava-to-coroutines-migration/SKILL.md)** - Migrating asynchronous code from RxJava to Coroutines and Flow.

### Performance
*   **[Compose Performance Audit](skills/performance/compose-performance-audit/SKILL.md)** - Identify recomposition storms and unstable keys.
*   **[Gradle Build Performance](skills/performance/gradle-build-performance/SKILL.md)** - Debug and optimize Gradle/Android build times.

### Concurrency & Networking
*   **[Kotlin Concurrency Expert](skills/concurrency_and_networking/kotlin-concurrency-expert/SKILL.md)** - Review and fix Kotlin Coroutines issues.
*   **[Android Coroutines](skills/concurrency_and_networking/android-coroutines/SKILL.md)** - Best practices for Coroutines execution and scopes.
*   **[Retrofit Networking](skills/concurrency_and_networking/android-retrofit/SKILL.md)** - Guidance on Retrofit, OkHttp, and Coroutines networking.

### Testing & Automation
*   **[Testing & Screenshots](skills/testing_and_automation/android-testing/SKILL.md)** - Setup for Unit, Hilt, and Screenshot Testing.
*   **[Android Emulator Automation](skills/testing_and_automation/android-emulator-skill/SKILL.md)** - Essential production scripts for automation and semantic navigation.

### Build & Tooling
*   **[Gradle Build Logic](skills/build_and_tooling/android-gradle-logic/SKILL.md)** - Setup Convention Plugins, Version Catalogs, and Composite Builds.
